...
function generateGameCard(game, idx, gamesDir) {
  ...
  return `<div class="card game-card" data-index="${idx}" data-folder="${game.folder}" data-name="${game.name.toLowerCase()}" onclick="window.location.href='games-html/${game.folder}.html'">
