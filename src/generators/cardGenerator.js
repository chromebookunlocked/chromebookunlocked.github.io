...
function generateGameCard(game, idx, gamesDir, loadEagerly = false) {
  ...
  return `<div class="card game-card" data-index="${idx}" data-folder="${game.folder}" data-name="${game.name.toLowerCase()}" onclick="window.location.href='/${encodeURIComponent(game.folder)}.html'">
