...
#backBtn, #recentBackBtn { background: #ff99ff; color: black; }
...
<script>
${fs.readFileSync(path.join(__dirname, "script_core.js"), "utf8")}
</script>
...
console.log("✅ Full site generated with functional Recently Played (Home row + full view).");
