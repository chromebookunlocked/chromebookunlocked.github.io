...
/* Group for search + bookmark on right side */
#rightHeaderGroup {
  display: flex;
  align-items: center;
  justify-content: flex-end;
  gap: 0.6rem;              /* small gap between bookmark and search */
  flex-shrink: 0;
  margin-left: auto;        /* pushes group to right side */
}

/* Bookmark button stays close to search bar */
#bookmarkBtn {
  order: 1;                 /* bookmark appears just left of search bar */
  padding: 0.6rem 1rem;
...
/* Keep search width flexible but aligned right */
#searchContainer {
  order: 2;
  flex: 0 1 300px;
  max-width: 400px;
