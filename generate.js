  ...
  <style>
    ...
    * {
    ...
    #sidebar:hover { 
      ...
      overflow-x:hidden;
      scrollbar-width: thin;
      scrollbar-color: rgba(77, 0, 102, 0.6) transparent;
    }
...
<body>
  ...
  <script>
    ...
    function searchGames(query) {
      ...
      if (topResults.length === 0) {
        ...
        searchDropdown.innerHTML = topResults.map(game => {
          return \`<div class="search-result-item" data-folder="\${game.folder}" data-name="\${game.name}" data-thumb="\${game.thumb}">
    ...
    document.addEventListener('DOMContentLoaded', () => {
      // Handle sidebar scrollbar visibility
      const sidebar = document.getElementById('sidebar');
      if (sidebar) {
        sidebar.addEventListener('mouseenter', () => {
          sidebar.style.scrollbarWidth = 'thin';
          sidebar.style.scrollbarColor = 'rgba(77, 0, 102, 0.6) transparent';
        });
        sidebar.addEventListener('mouseleave', () => {
          sidebar.style.scrollbarWidth = 'none';
          sidebar.style.scrollbarColor = 'transparent transparent';
        });
      }
