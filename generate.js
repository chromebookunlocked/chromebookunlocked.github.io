...
/* Group to keep bookmark and search aligned right */
#rightHeaderGroup {
  display: flex;
  align-items: center;
  justify-content: flex-end;
  gap: 0.6rem;           /* small space between bookmark and search */
  margin-left: auto;     /* pushes group to the far right */
}

/* Bookmark button styling (unchanged visually) */
#bookmarkBtn {
  padding: 0.6rem 1rem;
...
/* Search bar container (kept same style) */
#searchContainer {
  flex: 0 1 350px;
  max-width: 500px;
  min-width: 200px;
