...
.viewer {
  position: relative;
  display: none; /* use 'flex' to show when needed */
...
/* Maintain fixed aspect ratio with padding trick */
.viewer::before {
  content: "";
  display: block;
...
.viewer iframe {
  ...
  height: 100%;
  border: none;
  background: transparent; /* ensures transparency if supported */
  object-fit: contain; /* keeps content inside without stretching */
