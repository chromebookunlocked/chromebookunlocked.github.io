...
const gamesHtmlDir = path.join(outputDir, "games-html");
...
games.forEach(game => {
  ...
  const gamePagePath = path.join(gamesHtmlDir, `${game.folder}.html`);
...
console.log(`✅ Generated ${generatedCount} game pages in games-html/ folder\n`);
