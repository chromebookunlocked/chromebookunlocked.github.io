...
<head>
  ...
  <style>
    * {
    ...
    .game-frame-wrapper:fullscreen .fullscreen-icon,
    .game-frame-wrapper:-webkit-full-screen .fullscreen-icon,
    .game-frame-wrapper:-moz-full-screen .fullscreen-icon {
      display: none;
    }

    .game-frame-wrapper:fullscreen .exit-fullscreen-icon,
    .game-frame-wrapper:-webkit-full-screen .exit-fullscreen-icon,
    .game-frame-wrapper:-moz-full-screen .exit-fullscreen-icon {
      display: block;
    }
    ...
    .game-card {
      width: 100%;
      aspect-ratio: 1 / 1;
      background: linear-gradient(135deg, rgba(77, 0, 102, 0.8), #5a0077);
      border-radius: 15px;
      overflow: hidden;
      cursor: pointer;
      transition: all 0.3s ease;
    ...
    .game-card:hover {
      transform: translateY(-5px) scale(1.03);
      background: linear-gradient(135deg, rgba(102, 0, 153, 0.9), #7700aa);
  ...
  <div class="game-container">
    <div class="game-frame-wrapper" id="gameWrapper">
      ...
      <div class="controls">
        ...
        <button class="icon-btn" id="fullscreenBtn" onclick="toggleFullscreen()" title="Fullscreen" aria-label="Toggle Fullscreen">
          <svg class="fullscreen-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"></path></svg>
          <svg class="exit-fullscreen-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
        </button>
      </div>
